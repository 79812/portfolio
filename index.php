      ...
      <div class="col-md-4 mb-4 mt-4">
        <div class="card bg-danger">
          <div class="card-body">
            ...
            <p>Name: André Arguello </br> Phone Number: 0629384239 </br> Email: andrearguello@fakemail.com</br> Adress: Deltaweg 205, 5709 AB Helmond</p>
      ...
      <div class="col-md-4 mb-4 mt-4">
        <div class="card bg-danger">
          <div class="card-body">
            ...
            <p>Here are somes of my projects: </br> Radiogaga </br> Gameworld </br> DC Heroes</p>
            <a href="/myprojects" class="btn btn-dark">My projects</a>
          </div>
        </div>
      </div>
    </div>
